<%-- 
    Document   : c-snacks
    Created on : Dec 19, 2023, 11:15:19 PM
    Author     : pulin
--%>
...
<div class="container px-4 section-padding "> 
    <h1 class="default-title">Snacks</h1><br> 
...
<%
    ...
    try {
        ...
        PreparedStatement statement = connection.prepareStatement("SELECT * FROM product WHERE category = 'Snacks'");
