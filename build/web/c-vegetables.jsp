<%-- 
    Document   : c-vegetables
    Created on : Dec 19, 2023, 11:16:51 PM
    Author     : pulin
--%>
...
<div class="container px-4 section-padding "> 
    <h1 class="default-title">Fresh Vegetables</h1><br> 
    <div class="row px-lg-5 mx-lg-2 " >
<%
    // Retrieve product information from the database
    try {
        Connection connection = DBConnect.getConnection();
        PreparedStatement statement = connection.prepareStatement("SELECT * FROM product WHERE category = 'FreshVegetables'");
