<%-- 
    Document   : checkout-register.jsp
    Created on : Dec 24, 2023, 1:17:29 PM
    Author     : pulin
--%>
                        ...
                        <div class="card-body p-5 text-center">
                          ...
                          <div class="mb-md-5 mt-md-4 pb-5">
                            ...
                            <div class="form-outline form-white mb-4">
                                ...
                                <input type="hidden" name="registrationForm" value="checkout">
                          ...
                          <div>
                            <p class="mb-0">Have already an account? <a href="checkout-login.jsp" class="text-white-50 fw-bold">Login</a>
                            </p>
                          </div>
