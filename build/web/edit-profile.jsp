<%-- 
    Document   : user-account2.jsp
    Created on : Dec 11, 2023, 4:13:30?PM
    Author     : pulin
--%>
                                    ...
                                    <div class="col-md-4">
                                        <div id="login-card" class="card p-4 pt-5 ">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <form class="pt-3" action="EditProfileServlet" method="post">
                                                    <input type="hidden" name="cusEmail" value="<c:out value="${cus.email}" />">
                                                    <input type="hidden" name="cusID" value="<c:out value="${cus.id}" />">
                                                    <input type="hidden" name="cusPhone" value="<c:out value="${cus.phone}" />">
                                                    <div class="row">
                                                        <div class="col-7">
                                                            <input type="text" placeholder="<c:out value="${cus.address}" />"  name="cusAddress" class="form-control " style="height: 2px; width: 100%; margin: 0px">
                                                    ...
                                                    <input type="hidden" name="cusID" value="<c:out value="${cus.id}" />">
                                                    <input type="hidden" name="cusAddress" value="<c:out value="${cus.address}" />">
                                                    <div class="row">
                                                        <div class="col-7">
                                                            <input type="text" placeholder="<c:out value="${cus.phone}" />"  name="cusPhone" class="form-control " style="height: 2px; width: 100%; margin: 0px">
                                            ...
                                            <p class=" mb-5 pb-lg-2 pt-3"><a class="text-white-50" href="user-account.jsp">Go Back</a></p>
