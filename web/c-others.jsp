<%-- 
    Document   : c-others
    Created on : Dec 19, 2023, 11:19:40 PM
    Author     : pulin
--%>
...
<div class="container px-4 section-padding "> 
    <h1 class="default-title">Other Grocery</h1><br> 
    <div class="row px-lg-5 mx-lg-2 " >
<%
    // Retrieve product information from the database
    try {
        Connection connection = DBConnect.getConnection();
        PreparedStatement statement = connection.prepareStatement("SELECT * FROM product WHERE category = 'OtherGrocery'");
