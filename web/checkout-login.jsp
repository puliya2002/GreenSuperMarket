<%-- 
    Document   : checkout-login
    Created on : Dec 24, 2023, 1:11:18 PM
    Author     : pulin
--%>
                    ...
                    <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                      <div id="login-card" class="" >
                        <div class="card-body p-5 text-center">
                          ...
                          <div>
                            <p class="mb-0">Don't have an account? <a href="checkout-register.jsp" class="text-white-50 fw-bold">Sign Up</a>
                            </p>
                          </div>
